...
export function DataTransferPage({ user }: { user: AppUser }) {
  ...
  async function connectStorage(provider: "google_drive"): Promise<void> {
  ...
  return (
    <section className="page">
      ...
      <article className="panel stack data-section-gap">
        <div><span className="eyebrow">SOLO PLAN ANUAL</span><h2>Backups y restores en tu nube</h2><p>La copia se guarda en la carpeta privada de la aplicación de Google Drive usando permisos mínimos. No se incluyen tokens OAuth, credenciales ni el estado de tu suscripción.</p></div>
