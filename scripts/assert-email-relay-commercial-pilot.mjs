...
const sql=read(`supabase/migrations/${migration[0]}`); const gateway=read("supabase/functions/email-relay-ingest/index.ts"); const worker=read("workers/email-relay/src/index.mjs"); const parser=read("supabase/functions/_shared/financial-parser.ts"); const ui=read("apps/web/src/components/EmailRelayCard.tsx");
